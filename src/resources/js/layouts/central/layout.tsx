...
// ponytail: hrefs point at the intended /central paths; siblings 404 until built.
const navItems: NavItem[] = [
    { title: 'Dashboard', href: '/central', icon: LayoutGrid },
    { title: 'Notifications', href: '/central/notifications', icon: Bell },
    { title: 'Inventory', href: '/central/inventory', icon: Package },
    { title: 'Catalog Management', href: '/central/catalog', icon: ClipboardList },
    { title: 'Request Approvals', href: '/central/requests', icon: SquareCheckBig },
    { title: 'PPMP Management', href: '/central/ppmp', icon: FileText },
    { title: 'Delivery', href: '/central/delivery', icon: Truck },
];
...
export default function CentralLayout({ children }: PropsWithChildren) {
    ...
    const isActive = (href: string) =>
        href === '/central' ? url === '/central' : url.startsWith(href);
